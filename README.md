...
|Huber|$\begin{equation} \frac{1}{2}(y_i - f(x_i))^2, \quad \vert y_i -f(x_i) \vert \leq \delta \\ \delta(\vert y_i - f(x_i) \vert - \frac{\sigma}{2}), \quad \vert y_i - f(x_i) \vert > \delta\\ \end{equation}$|/|
